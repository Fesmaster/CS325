...
class MyScene extends Phaser.Scene {
    ...
    create() {
        ...
        for (let i=0;i<5;i++){
            ...
            this.keys[i].key_image = this.add.image(this.keys[i].wpos.x, this.keys[i].wpos.y, "key");
        }
        ...
        this.navGraphics.fillStyle(0x008f00);
